...
class table(models.Model):
    ...
    new_asset_number = models.CharField(verbose_name='新资产编号', max_length=16, blank=True, null=True, unique=True, default='')
...
class comment(models.Model):
    def __str__(self):
        return ''
    info = models.TextField(verbose_name='备注', max_length=512, blank=False, null=False)
